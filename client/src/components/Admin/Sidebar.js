...
const Sidebar = ({ setActiveMenuItem }) => {
  ...
  return (
    <aside className="bg-gray-900 text-white w-64 min-h-screen h-auto pl-4 pr-4 pb-4 z-40">
      <div className="flex items-center fixed pt-4 pb-4 left-5 bg-gray-900 z-20">
        <img src="/images/header/logo.png" alt="" className="h-12 w-12" />
      ...
      {/* Add a logout button or other additional items as needed */}
    </aside>
  );
};
